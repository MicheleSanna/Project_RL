...
class PokerEnv:
    ...
    def get_current_obs(self, is_terminal):
        ...
        print("Table state: ", self._get_table_state(normalization_sum=1))
        print("Table state normalized: ", self._get_table_state(normalization_sum=normalization_sum))
        print("Player states: ", self._get_player_states_all_players(normalization_sum=1))
        print("Player states normalized: ", self._get_player_states_all_players(normalization_sum=normalization_sum))
        print("Board state: ", self._get_board_state())
